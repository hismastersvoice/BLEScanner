...
#define MQTT_PASSWORD     "mqtt_pass" /*Your MQTT password*/
#define MQTT_SERVER       "192.168.0.101" /*Your MQTT server address*/
#define MQTT_SERVER_PORT  1883

//UDP
#define UDP_SERVER        "192.168.0.102" /*IP of the UDP server*/
