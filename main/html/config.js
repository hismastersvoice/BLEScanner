$(document).ready(() => {
  ...
  $('#saveBtn').click(function (e) {
    ...
    formData.append('mqttenabled', $('#mqttenabled').is(':checked') ? 'true' : '');
...
function PopulatePage(data) {
  ...
  if (data.mqtt_enabled) {
    $("#mqttenabled_div").removeClass("hidden");
  } else {
    $("#mqttenabled_div").addClass("hidden");
  }
 
  $('#udpenabled').prop('checked', data.udp_enabled);
  if (data.udp_enabled) {
    $("#udpenabled_div").removeClass("hidden");
  } else {
  $("#udpenabled_div").addClass("hidden");
  }
  $('#dhcpenabled').prop('checked', data.dhcp_enabled);
  
  if (data.dhcp_enabled) {
    $("#dhcpenabled_div").addClass("hidden");
  } else {
